<template>
  <div class="battle">
    ...
    <div class="upload">
      <upload v-bind:isProfile="isProfile" v-bind:acceptedFormat="acceptedFormat" style="width: 150px; height: 100px; line-height: 100px;"
        message="上传代码"></upload>
      <div>
        <i class="el-icon-info">点击或拖拽上传</i>
      </div>
      <div>
    ...
    <el-table :data='team' :default-sort="{prop: 'teamscore', order: 'descending'}" stripe>
      ...
      <el-table-column label="操作" align="center">
        <template slot-scope="scope">
          <el-button size="mini" @click="handleBattle(scope.$index, scope.row)">对战</el-button>
        </template>
      </el-table-column>
    </el-table>
    <h4>查看代码</h4>
